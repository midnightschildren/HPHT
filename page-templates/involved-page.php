...
<div class="col grid-12 bung_red">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php if( get_field('alternative_title') ): ?>
						<h2><?php the_field('alternative_title'); ?></h2>
					<?php else: ?>
						<h2><?php the_title(); ?></h2>
					<?php endif; ?>	
					<div class="preservation involved pad-3-vert">
						<?php the_content(); ?>
					</div>
	...
	<div class="col ivory grid-12 pad-3-vert s-pad-3-top s-pad-1-bottom">
		<div class="eccla_wrapper">
		<div class="col grid-12">
