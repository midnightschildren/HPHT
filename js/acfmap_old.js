...
function add_marker( $marker, map ) {
  ...
  },
 {
    ...
    var category_vis = "trip";
    center_map( map );
    for (i = 0; i < map.markers.length; i++) {
        marker2 = map.markers[i];
        // If is same category or category not picked
        if (marker2.category == category_vis ) {
    ...
    var category_vis = "classroom";
    center_map( map );
    for (i = 0; i < map.markers.length; i++) {
        marker6 = map.markers[i];
        // If is same category or category not picked
        if (marker6.category == category_vis ) {
    ...
    var category_vis = "resource";
    center_map( map );
    for (i = 0; i < map.markers.length; i++) {
        marker7 = map.markers[i];
        // If is same category or category not picked
        if (marker7.category == category_vis ) {
