		...
		<div class="col pad-3-vert grid-11">
			...
			<div class="col pad-3-vert grid-10 s-grid-12 m-grid-11">
				<div class="col grid-10 s-grid-12 m-grid-12">
					<?php if( get_field('admission') ): ?><p class="scholar"><strong>Admission: </strong><?php the_field( "admission" ); ?></p><?php endif; ?>
					<?php if( get_field('scholarships') ): ?><p class="scholar"><strong>Bus Scholarships: </strong><?php the_field( "scholarships" ); ?></p><?php endif; ?>
